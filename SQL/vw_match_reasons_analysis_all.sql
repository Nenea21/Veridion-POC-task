...
/****** Object:  View [dbo].[vw_match_reasons_analysis_all]    Script Date: 03/08/2025 05:42:04 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vw_match_reasons_analysis_all] AS
WITH split_reasons AS (
    ...
    FROM veridion_analysis_entity_resolution
